...
var LoginForm = function (_a) {
    ...
    var username = useSelector(selectLoginUsername);
    var password = useSelector(selectLoginPassword);
    var isLoading = useSelector(selectLoginIsLoading);
    var error = useSelector(selectLoginError);
    var handleUsernameChange = useCallback(function (username) {
        dispatch(loginActions.setUsername(username));
    }, [dispatch]);
    var handlePasswordChange = useCallback(function (password) {
