...
describe('updateProfileData', function () {
    ...
    test('should be fulfilled/profileData', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk, result;
    ...
    test('should be rejected/SERVER_ERROR if put status 403', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test('should be rejected/NO_DATA if client error', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//# sourceMappingURL=updateProfileData.test.js.map