...
export var initArticlesPage = createAsyncThunk('articlesPage/initArticlesPage', function (searchParams, thunkAPI) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        isInit = selectArticlesPageIsInit(getState());
        if (!isInit) {
            Object.entries(articlesPageActions).forEach(function (_a) {
                var name = _a[0], action = _a[1];
                var searchParamsKey = name.replace(/set/gm, '').toLowerCase();
                var searchParamsValue = searchParams.get(searchParamsKey);
...
//# sourceMappingURL=initArticlesPage.js.map